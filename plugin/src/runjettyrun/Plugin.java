...
public class Plugin extends AbstractUIPlugin {
    ...
    public static final String ATTR_WEBAPPDIR = Plugin.PLUGIN_ID + ".WEBAPPDIR_ATTR";
    ...
    public static final String ATTR_SSL_PORT = Plugin.PLUGIN_ID + ".SSL_PORT_ATTR";

    /** configuration attribute for the location of the keystore. */
    public static final String ATTR_KEYSTORE = Plugin.PLUGIN_ID + ".KEYSTORE_ATTR";
    ...
    public static final String JETTY_VERSION = "6.1.25";
    ...
    static public void logError(Exception e) {
        ...
        Status status = new Status(IStatus.ERROR, getDefault().getBundle().getSymbolicName(), IStatus.ERROR, msg, null);
        log.log(status);
    }

    static public void logError(String msg) {
        ILog log = plugin.getLog();
        Status status = new Status(IStatus.ERROR, getDefault().getBundle().getSymbolicName(), IStatus.ERROR, msg + "\n", null);
        log.log(status);
    }
    ...
    protected void initializeImageRegistry(ImageRegistry reg) {
        ...
        URL imageURL = this.getBundle().getEntry(JETTY_ICON_PATH);
        if (imageURL != null) {
